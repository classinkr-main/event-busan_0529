...
export default function Agenda() {
  return (
    <section id="agenda" className="relative py-32 sm:py-40">
      <div className="max-w-5xl mx-auto px-6 sm:px-10">
        <div className="text-center mb-16">
          <p className="text-sm tracking-[0.3em] text-white/50 mb-4">AGENDA</p>
          <h2 className="text-6xl sm:text-7xl md:text-8xl font-bold tracking-tight">
            5<span className="text-gradient">/</span>29
          </h2>
          <div className="mt-3 text-xl sm:text-2xl text-white/70 font-light tracking-wider">
            2026 · FRIDAY
          </div>
          ...
          <div className="mt-8 inline-flex items-center gap-2 glass rounded-full px-5 py-2.5">
            ...
            <span className="text-sm text-white/80">부산 과사람 WP타워</span>
          </div>
        </div>
          ...
          <div className="space-y-8">
            {schedule.map((item, idx) => (
              ...
              >
                ...
                <div className="pl-12 sm:pl-0 sm:flex-1 sm:px-8">
                  <div
                    className={`glass-strong rounded-2xl p-6 sm:p-7 ${
                      idx % 2 === 0 ? "sm:text-right" : ""
                    }`}
                  >
                    <div className="text-xs tracking-[0.2em] text-[var(--accent-from)] mb-2 font-medium">
                      {item.time}
                    </div>
